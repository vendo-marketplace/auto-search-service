...
public class AutoSearchFilter extends OncePerRequestFilter {

    private final AutoSearchAntPathResolver autoSearchAntPathResolver;
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return autoSearchAntPathResolver.isPermittedPath(requestURI);
    }
}
