...
@ActiveProfiles("test")
public class AutoSearchCommandControllerIntegrationTest {
    ...
    class CreateTests {
        ...
        void create_shouldReturnNotFound_whenCategoryNotFound() throws Exception {
            ...
            doThrow(new CategoryNotFoundException("Category not found.")).when(autoSearchCommandUseCase).create(any(AutoSearch.class));
    ...
    class DeleteTests {
        ...
        void delete_shouldReturnNotFound_whenRequestDoesNotExistOrNotOwned() throws Exception {
            ...
            String content = mockMvc.perform(delete("/auto-search/{id}", id)
                            .with(SecurityMockMvcRequestPostProcessors.securityContext(securityContext)))
